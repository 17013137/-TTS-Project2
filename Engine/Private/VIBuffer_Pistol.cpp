#include "..\Public\VIBuffer_Pistol.h"



CVIBuffer_Pistol::CVIBuffer_Pistol(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CVIBuffer(pGraphic_Device)
{
}

CVIBuffer_Pistol::CVIBuffer_Pistol(const CVIBuffer_Pistol & rhs)
	:CVIBuffer(rhs)
{
}

HRESULT CVIBuffer_Pistol::NativeConstruct_Prototype()
{
	...
	_Normal = (_float3(-1.f, 0.f, 0.f) + _float3(0.f, 1.f, 0.f) + _float3(0.f, 0.f, 1.f)) / 3.f;
	D3DXVec3Normalize(&_Normal, &_Normal);
	pVertices[32].vPosition = _float3(-0.02f, 0.32f, 0.32f);
...
HRESULT CVIBuffer_Pistol::NativeConstruct(void * pArg)
{
...
CVIBuffer_Pistol * CVIBuffer_Pistol::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CVIBuffer_Pistol*	pInstance = new CVIBuffer_Pistol(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_Pistol"));
...
CComponent * CVIBuffer_Pistol::Clone(void * pArg)
{
	CVIBuffer_Pistol*	pInstance = new CVIBuffer_Pistol(*this);
