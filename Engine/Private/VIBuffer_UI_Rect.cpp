#include "..\Public\VIBuffer_UI_Rect.h"



CVIBuffer_UI_Rect::CVIBuffer_UI_Rect(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CVIBuffer(pGraphic_Device)
{

}

CVIBuffer_UI_Rect::CVIBuffer_UI_Rect(const CVIBuffer_UI_Rect & rhs)
	: CVIBuffer(rhs)
{

}

HRESULT CVIBuffer_UI_Rect::NativeConstruct_Prototype()
{
...
HRESULT CVIBuffer_UI_Rect::NativeConstruct(void * pArg)
{
...
CVIBuffer_UI_Rect * CVIBuffer_UI_Rect::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CVIBuffer_UI_Rect*	pInstance = new CVIBuffer_UI_Rect(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_UI_Rect"));
...
CComponent * CVIBuffer_UI_Rect::Clone(void * pArg)
{
	CVIBuffer_UI_Rect*	pInstance = new CVIBuffer_UI_Rect(*this);
