...
class CSteve_Dummy final : public CGameObject
{
public:
...
private:
	explicit CSteve_Dummy(LPDIRECT3DDEVICE9 pGraphic_Device);
	CSteve_Dummy(const CSteve_Dummy& rhs);
	virtual ~CSteve_Dummy() = default;
...
public:
	static CSteve_Dummy* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
