...
class CGranpa_Skeleton final : public CBlendObject
{
public:
...
private:
	...
	explicit CGranpa_Skeleton(LPDIRECT3DDEVICE9 pGraphic_Device);
	CGranpa_Skeleton(const CGranpa_Skeleton& rhs);
	virtual ~CGranpa_Skeleton() = default;
...
private:
	...
	CVIBuffer_Timber*		m_vVITimber = nullptr;
...
public:
	static CGranpa_Skeleton* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
