...
class CWither_skeleton2 final : public CBlendObject
{
public:
...
private:
	...
	explicit CWither_skeleton2(LPDIRECT3DDEVICE9 pGraphic_Device);
	CWither_skeleton2(const CWither_skeleton2& rhs);
	virtual ~CWither_skeleton2() = default;
...
public:
	static CWither_skeleton2* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
