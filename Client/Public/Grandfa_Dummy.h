...
class CGrandfa_Dummy final : public CGameObject
{
public:
...
private:
	explicit CGrandfa_Dummy(LPDIRECT3DDEVICE9 pGraphic_Device);
	CGrandfa_Dummy(const CGrandfa_Dummy& rhs);
	virtual ~CGrandfa_Dummy() = default;
...
public:
	static CGrandfa_Dummy* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
