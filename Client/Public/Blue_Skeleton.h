...
class CBlue_Skeleton final : public CBlendObject
{
public:
...
private:
	...
	explicit CBlue_Skeleton(LPDIRECT3DDEVICE9 pGraphic_Device);
	CBlue_Skeleton(const CBlue_Skeleton& rhs);
	virtual ~CBlue_Skeleton() = default;
...
public:
	static CBlue_Skeleton* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
